...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class ActoresControllerTests : BasePruebas
    {
        ...
        public async Task ObtenerPersonasPaginadas()
        {
            ...
            var controller = new ActoresControllers(contexto2, mapper, null);
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActoresCreacionDTO() { Nombre = "Felipe", FechaNacimiento = DateTime.Now };

            var mock = new Mock<IAlmacenadorArchivos>();
            mock.Setup(x => x.GuardarArchivo(null, null, null, null))
                .Returns(Task.FromResult("url"));

            var controller = new ActoresControllers(contexto, mapper, mock.Object);
        ...
        public async Task CrearActorConFoto()
        {
            ...
            var actor = new ActoresCreacionDTO()
            {
                Nombre = "nuevo actor",
        ...
        public async Task PatchRetorna404SiActorNoExiste()
        {
            ...
            var controller = new ActoresControllers(contexto, mapper, null);
            var patchDoc = new JsonPatchDocument<ActorDTOPatch>();
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            var patchDoc = new JsonPatchDocument<ActorDTOPatch>();
            patchDoc.Operations.Add(new Operation<ActorDTOPatch>("replace", "/nombre", null, "Claudia"));
            var respuesta = await controller.Patch(1, patchDoc);
            var resultado = respuesta as StatusCodeResult;
